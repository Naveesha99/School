...
const CleanerPage = () => {
    ...
    const fetchCleaner = async () => {
        try {
            const response = await axios.get('/Cleaner');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('/Cleaner/create', newCleaner);
            setNewCleaner({
                CleanerID: '',
                CleanerName: '',
                CleanerContact: '',
    ...
    const handleDelete = async (CleanerID) => {
        try {
            await axios.delete(`/Cleaner/delete/${CleanerID}`);
            fetchCleaner();
        } catch (error) {
    ...
    const handleUpdate = async () => {
        ...
        try {
            await axios.put(`/Cleaner/update/${selectedCleaner.CleanerID}`, selectedCleaner);
            setEditMode(false);
