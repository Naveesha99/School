...
const StaffPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('/Staff/create', newStaffMember);
            setNewStaffMember({
                StaffID: '',
                StaffName: '',
                StaffEmail: '',
    ...
    const handleDelete = async (StaffID) => {
        try {
            await axios.delete(`/Staff/delete/${StaffID}`);
            fetchStaff();
        } catch (error) {
    ...
    const handleUpdate = async () => {
        ...
        try {
            await axios.put(`/Staff/update/${selectedStaffMember.StaffID}`, selectedStaffMember);
            setEditMode(false);
